        ...
        <td style="{{ $style['email-wrapper'] }}" align="center"><table width="100%" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td style="{{ $style['email-masthead'] }}">
                        ...
                        <br/><br/><div align="center">MiniSend</div></td>
                </tr>
                <!-- Email Body -->
                <tr>
                ...
                <tr>
                    <td><table style="{{ $style['email-footer'] }}" align="center" width="570" cellpadding="0" cellspacing="0">
                            <tr>
                                <td style="{{ $fontFamily }} {{ $style['email-footer_cell'] }}"><p style="{{ $style['paragraph-sub'] }}"> &copy; {{ date('Y') }} <a style="{{ $style['anchor'] }}" href="{{ env('APP_URL') }}" target="_blank">{{ env('APP_URL') }}</a>.
